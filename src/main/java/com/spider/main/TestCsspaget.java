...
//					System.out.println(doc.selectFirst(refcss+" "+urlcss).attr("abs:href"));
...
//					writeMethod(ArticleGet.getArticleContent(doc.select(contcss),driver.getCurrentUrl()).html());
//					
